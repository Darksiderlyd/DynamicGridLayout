package com.tool.dynamicgridlayout.widget.mygrid;
 ...
 */
public class DynamicGridLayout<D extends BaseGridData, A extends BaseAdapter<D, BaseViewHolder<D>>> extends GridLayout {
    ...
    private void loadView() {
        ...
        for (int i = 0; i < mAdapter.getItemCount(); i++) {
            ...
            int leftMargin = data.getStartX() == 0 ? mSpace : mHalfSpace;
            int topMargin = data.getStartY() == 0 ? mSpace : mHalfSpace;
            int rightMargin = data.getEndX() % getColumnCount() == 0 ? mSpace : mHalfSpace;
            int bottomMargin = data.getEndY() % getRowCount() == 0 ? mSpace : mHalfSpace;
